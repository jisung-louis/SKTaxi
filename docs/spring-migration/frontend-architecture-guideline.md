...
> 최종 수정일: 2026-03-20
> 관련 문서: [RN Spring 연동 로드맵](./frontend-integration-roadmap.md) | [RN Spring API 커버리지와 로깅 가이드](./frontend-api-coverage.md) | [API 명세](./api-specification.md) | [역할 정의](./role-definition.md)
