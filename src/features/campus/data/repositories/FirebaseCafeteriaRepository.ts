...
import { ICafeteriaRepository } from './ICafeteriaRepository';

/**
 * Firestore 기반 Cafeteria Repository 구현체
 */
export class FirebaseCafeteriaRepository implements ICafeteriaRepository {
...
export { FirebaseCafeteriaRepository as FirestoreCafeteriaRepository };
