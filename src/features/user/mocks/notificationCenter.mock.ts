...
export const NOTIFICATION_CENTER_MOCK: NotificationInboxSourceItem[] = [
  {
    ...
    notification: {
      ...
      data: {
        commentId: 'mock-board-comment-1',
  ...
  },
  {
    ...
    notification: {
      ...
      data: {
        commentId: 'mock-board-comment-2',
  ...
  },
  {
    ...
    notification: {
      ...
      data: {
        commentId: 'mock-board-comment-3',
  ...
  },
  {
    ...
    notification: {
      ...
      data: {
        commentId: 'mock-board-comment-4',
  ...
  },
  {
    ...
    notification: {
      ...
      title: '파티에서 강퇴되었어요',
      message:
        '리더가 회원님을 파티에서 내보냈어요. 다른 택시 파티를 찾아보세요.',
      data: {
