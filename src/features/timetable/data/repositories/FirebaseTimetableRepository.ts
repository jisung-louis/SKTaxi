...
import { ITimetableRepository, Timetable } from './ITimetableRepository';

/**
 * Firestore 기반 Timetable Repository 구현체
 * userTimetables 컬렉션의 courseId 배열만 관리
 */
export class FirebaseTimetableRepository implements ITimetableRepository {
...
export { FirebaseTimetableRepository as FirestoreTimetableRepository };
