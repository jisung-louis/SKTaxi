...
import { lookupMinecraftUuid } from '../../services/minecraftLookupService';
...
export class FirebaseMinecraftRepository implements IMinecraftRepository {
...
export { FirebaseMinecraftRepository as FirestoreMinecraftRepository };
