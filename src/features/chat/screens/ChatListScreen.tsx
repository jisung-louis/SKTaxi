...
import { ChatListHeader, ChatRoomCard, EmptyChatList } from '../components';
import { useChatListPresenter } from '../hooks/useChatListPresenter';
      ...
      <Animated.View style={[styles.content, screenAnimatedStyle]}>
        ...
        {loading && shouldShowEmpty ? (
          ...
          <FlatList
            ...
            ListEmptyComponent={
              shouldShowEmpty ? <EmptyChatList type="no-participation" /> : null
            }
