...
export const EmptyChatList = ({ type }: EmptyChatListProps) => {
  if (type === 'no-participation') {
    return (
      <View style={styles.emptyContainer}>
        ...
        <Text style={styles.emptyMessage}>새로운 채팅방을 만들거나 초대를 받아보세요</Text>
      </View>
    );
  }
  ...
  return (
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.emptyMessage}>새로운 채팅방이 있으면 여기에 표시됩니다</Text>
    </View>
  );
};
