...
import { BOARD_CATEGORIES, SORT_OPTIONS } from '../model/constants';
import type { BoardCategory } from '../model/types';
import { useBoardCategoryCounts } from '../hooks/useBoardCategoryCounts';
  ...
  const renderSortItem = ({ item }: { item: { value: string; label: string } }) => {
    ...
    const getSortIcon = (value: string) => {
      switch (value) {
        ...
        case 'mostCommented': return 'chatbubble-outline';
        case 'mostViewed': return 'eye-outline';
