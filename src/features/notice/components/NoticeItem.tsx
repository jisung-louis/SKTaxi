...
export function NoticeItem({ notice, isRead, onPress }: NoticeItemProps) {
  return (
    <TouchableOpacity
      style={[styles.noticeItem, !isRead && styles.unreadNotice]}
    ...
    >
      ...
      <View style={styles.noticeHeader}>
        <Text
          style={[styles.noticeTitle, !isRead && styles.unreadTitle]}
          numberOfLines={2}
        >
          {notice.title}
        </Text>
      ...
      <View style={styles.noticeFooter}>
        <View style={styles.noticeFooterLeft}>
          <Text style={styles.noticeDate}>{formatNoticePostedAt(notice.postedAt)}</Text>
        </View>
