/**
 * @deprecated 이 통합 훅은 Firebase 직접 접근으로 DIP 원칙 위반.
 *
 * 대체 훅:
 * - 게시판 댓글: import { useBoardComments } from '../hooks/board';
 * - 공지 댓글: import { useNoticeComments } from '../hooks/notice';
 *
 * 새로운 코드에서는 위의 분리된 훅들을 사용하세요.
 */
